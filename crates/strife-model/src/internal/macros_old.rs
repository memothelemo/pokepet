macro_rules! enum_event_type {
  {
    ...
    $crate::internal::macros::enum_string! {
      ...
      $vis enum $Name {
        $(
          $( #[$VariantMeta] )*
          $Variant = ::strife_macros::shouting_snake_case_str!($Variant),
        )*
      }
    }
  };
...
macro_rules! enum_repr {
        ...
        D: serde::Deserializer<'de>,
      {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
          ...
          where
            E: serde::de::Error,
          {
            $Name::__internal_enum_repr(value).ok_or_else(|| {
  ...
  {$(
    ...
    $crate::internal::macros::enum_repr!(impl base for $Name);
  )*};
  {$(
    $( #[$EnumMeta:meta] )*
